		...
		return (
			<div id="monParcours__layout" className="monParcours__layout page__layout">
				<div id="lstEtape" className="lstEtape">
					<EtapeParcours index="0" imgPath={operisLogo} date="2013-2020" titre="Operis" texte=" duofhq osmfmoqsdfnmq sdfndomsfjqs ifbmqsdlmfj qsdmiofj qsdjfiomqsd fiomqsdh fioqsdj gqsiodmgh iqsdfh ioqsdjf hqsiofj jqspdifh iosmqfj siqdofhi qsd fjhioqsdfj qsdiof qsipdf hqsiodf jqsiomdf qsdif hiosq"/>
					<EtapeParcours index="1" imgPath={operisLogo} date="2013-2020" titre="Operis" texte=" duofhq osmfmoqsdfnmq sdfndomsfjqs ifbmqsdlmfj qsdmiofj qsdjfiomqsd fiomqsdh fioqsdj gqsiodmgh iqsdfh ioqsdjf hqsiofj jqspdifh iosmqfj siqdofhi qsd fjhioqsdfj qsdiof qsipdf hqsiodf jqsiomdf qsdif hiosq"/>
